...
namespace Chubberino.Modules.CheeseGame.Quests.GainStorage
{
    ...
    {
        public FindTombQuest(ApplicationContext context, Random random, IMessageSpooler spooler, IEmoteManager emoteManager) : base(context, random, spooler, emoteManager)
        {
        }
